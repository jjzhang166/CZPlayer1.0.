...
AlbumThread::AlbumThread(QString name, QString artist, QLabel *albumImage)
            : m_musicName(name), m_musicArtist(artist), m_albumImage(albumImage)
{
//    QString urlStr = "http://geci.me/api/lyric/" + m_musicName + "/" + m_musicArtist;
...
//    }
    ...
    albumFilePath = albumImagesName + "/" + m_musicArtist + " - " + m_musicName + ".jpg";
